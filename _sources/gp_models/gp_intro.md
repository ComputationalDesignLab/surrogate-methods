...
$$\mu_{f|D}(x) = \mu(x) + K(x,X)K(X,X)^{-1}(f-\mu(X)) \text{and} K_{f|D}(x, x') = K(x, x') - K(x, X)K(X,X)^{-1}K(X,x')$$.
...
$$\mu_{f|D}(x) = \mu(x) + K(x,X)(K(X,X)+\sigma_n^2 I)^{-1}(f-\mu(X)) \text{and} K_{f|D}(x, x') = K(x, x')+\sigma_n^2 I - K(x, X)(K(X,X)+\sigma_n^2 I)^{-1}K(X,x')$$, 
